...
public class PopShare extends PopupWindow {
	...
	public void init() {
		...
		rl_pop_main.setOnClickListener(new OnClickListener() {
...
//						.share();
	...
	// CommFunMessage.ShowMsgBox(mContext, platform + "分享成功啦");
	// }
	//
	// @Override
	// public void onError(SHARE_MEDIA platform, Throwable t) {
	// CommFunMessage.ShowMsgBox(mContext, platform + "分享失败啦");
	// }
	//
	// @Override
	// public void onCancel(SHARE_MEDIA platform) {
	// CommFunMessage.ShowMsgBox(mContext, platform + "分享取消了");
	// }
	// };
