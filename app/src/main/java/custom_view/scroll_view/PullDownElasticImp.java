package custom_view.scroll_view;
...
public class PullDownElasticImp implements IPullDownElastic {
	...
	private void init() {
		// 刷新视图顶端的的view
		refreshView = LayoutInflater.from(mContext).inflate(R.layout.pulldown_header_scrollview, null);

		// 指示器view
		arrowImageView = (ImageView) refreshView.findViewById(R.id.head_arrowImageView);
		// 刷新bar
		progressBar = (ProgressBar) refreshView.findViewById(R.id.head_progressBar);
		// 下拉显示text
